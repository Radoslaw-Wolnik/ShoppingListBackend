...
public interface IShoppingListService
{
    ...
    Task<ShoppingListCategory> AddCategoryAsync(Guid listId, Guid requesterId, string categoryName);
    ...
    Task<ShoppingListItem> AddItemAsync(Guid categoryId, Guid requesterId, string description);
